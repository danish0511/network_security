...
class TrainingPipeline:
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            data_transformation_config=DataTransformationConfig(training_pipelien_config=self.training_pipeline_config)
    ...
    def run_pipeline(self):
        try:
            ...
            data_transformation_artifact=self.start_data_transformation(data_validation_artifact=self.data_validation_artifact)
